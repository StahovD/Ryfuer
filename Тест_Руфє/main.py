...
Window.clearcolor = (.100, .69, .47, .1)
btn_color = (.44, .85, .83, .20)
...
class PulseScr(Screen):
    def __init__(self, **kwargs):
        ...
        self.line3 = BoxLayout(size_hint=(.8, None),
                               height="80sp", pos_hint={'center_x': .5})
...
class RelaxScr(Screen):
    def __init__(self, **kwargs):
        ...
        self.btn = Button(text="Start", size_hint=(.3, .2),
...
class PulseScr2(Screen):
    def __init__(self, **kwargs):
        ...
        self.lbl_sec = Seconds(1)
        self.lbl_sec.bind(done=self.sec_finished)
        self.lbl1 = Label(text = "Count you heart rate")
        ...
        self.btn = Button(text="Star", size_hint=(
            0.3, .2), pos_hint={'center_x': 0.5})
        self.btn.background_color = btn_color
        self.btn.on_press = self.next
